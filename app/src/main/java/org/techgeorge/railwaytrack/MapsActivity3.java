...
import org.techgeorge.railwaytrack.databinding.ActivityMaps3Binding;
import org.techgeorge.railwaytrack.databinding.ActivityMaps4Binding;
...
public class MapsActivity3 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        DatabaseReference myRef = database.getReference("Latitude3");
        DatabaseReference myRef2 = database.getReference("Longitude3");
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                try {
                    ...
                    mMap.addMarker(new MarkerOptions().position(latLng).title("Train are in same track"));
